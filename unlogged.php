...
<body>
    ...
    <section class="encourage">
        <div class="encourage_background"> 
            <img src="./img/unloggedimage.jpg" alt="" width="100%">
            <div class="encourage_hero_background">
                <div class="encourage_container">
                    <div class="encourage_items">
                        <div class="encourage_head">
                            ...
                            <span>
                                Zaczynamy oglądać? Naciśnij poniższy przycisk aby utworzyć lub odnowić konto.
                            </span>
                            <a href='./utworzkonto.php'> 
                                <button style=" color: white; background-color: red; border: none; padding: 15px 100px; border-radius: 4%; margin-right: 10px;">
                                DOŁĄCZ TERAZ
                                </button>
                            </a>
                        </div>
